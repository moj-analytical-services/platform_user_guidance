...
In order to deploy a Shiny app, you should follow these steps:
...
The `disable_authenication` parameter controls whether sign-in is required for users to access the app. It can take the values `true` or `false`. In general, this should be set to `false`. If you wish to disable authentication, you should first discuss this with the Analytical Platform team.
