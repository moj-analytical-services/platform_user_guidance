...
ResolvePackageNotFound:
  - r-pillar==1.4.2=h6115d3f_0
  ```
  
Then the above command needs to be split up. 
...
2. Delete the r-pillar line from `/tmp/base.yml`. You can do this in RStudio by selecting __File__ > __Open File__, typing in `/tmp`, and then finding the relevant file. 

3. Run the following in a terminal: 

```bash
echo > $CONDA_PREFIX/conda-meta/history && conda env update --prune -n rstudio -f /tmp/base.yml && rm /tmp/base.yml
```
