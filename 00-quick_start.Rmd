...
- [**Jenkins:**](https://jenkins.services.alpha.mojanalytics.xyz/) Allows you to publishing your data products such as R Shiny apps to the web.
...
The following is a high level diagram of the platform:
