...
__This section of the guidance is currently being updated.__
...
* __Email address__
* __Phone number__
* __Is the person carrying out the data movement the same as the requestor?__
* __Name of the person carrying out the data movement__
* __Email address of the person carrying out the data movement__
* __Phone number of the person carrying out the data movement__
...
* __Will the data be modified or changed in order to mask sensitive content?__  
  Guidance on masking and anonymisation can be found in section \@ref(data-minimisation).
* __How will the data be changed or modified in order to mask sensitive content?__
...
* __Is MoJ the controller responsible for the data?__  
  A controller is an entity registered with the Information Commissioner's Office (ICO) that exercises overall control over the purposes and means of the processing of personal data. MoJ is the controller for MoJ HQ, HMPPS, HMCTS, LAA, OPG and some other agencies and public bodies. If you are unsure whether MoJ is the controller responsible for the data, please contact the Analytical Platform team [here]( mailto:analytical-platform@digital.justice.gov.uk).
* __Who is the controller responsible for the data?__  
The controller could be another MoJ agency or public body (for which MoJ is not the responsible controller), another government department or a third party. You can use the [ICO Data Protection Register](https://ico.org.uk/ESDWebPages/Search) to determine whether an entity is a controller. The following agencies and public bodies are controllers:
...
* __Is a suitable data sharing agreement in place?__
* __Is the controller aware of the data movement and the intended use of the Analytical Platform?__
...
* __Which GitHub repository will the data be stored in?__
* __What is the approximate size of the data?__
...
* __Is a technical migration form required?__  
  A technical migration form may be required for recurring data movements or where there is an integration with other systems. If you are unsure whether your data movement requires a technical migration form, please contact the [Analytical Platform team](mailto:analytical-platform@digital.justice.gov.uk).
...
You should seek approval from the relevant IAO for all data movements.
...
* __Have you discussed the data movement with the relevant information security team(s)?__  
  The local information security contact for MoJ HQ is [Joel Samuel](mailto:joel.samuel@digital.justice.gov.uk). The relevant team for HMCTS is led by [Michael Hanley](mailto:michael.hanley@justice.gov.uk) and for HMPSS by [Pat Clarke](mailto:patrick.clarke@hmps.gsi.gov.uk).
