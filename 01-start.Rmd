...
This page covers only the initial setup.  For guidance on how to use Git to sync your work with Github, please see the following guidance [here](http://r-pkgs.had.co.nz/git.html#git-rstudio).
