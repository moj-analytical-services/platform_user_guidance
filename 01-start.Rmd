...
## Getting an account
### Sign up for github 
In order to provide you with an account on the platform, we require your github username. If you do not already have an account, head off to https://github.com/, and sign up. When signing up, use all the default options.
...
Once you've got a Github account setup, email you account name [Robin Linacre](mailto:Robin.Linacre@justice.gsi.gov.uk) and [Leanne Mills](mailto:leanne.mills@digital.justice.gov.uk) who will create an Analytical Platform account for you. 
