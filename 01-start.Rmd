...
You are given the option of doing this via SMS or an authentication app (such as [Authy](https://authy.com/download/) or [Google Authenticator](https://support.google.com/accounts/answer/1066447?hl=en)) - choose whichever you prefer.  Please save a copy of your recovery codes e.g. by emailing them to your secure government email address.
...
If you are new to Git and Github it is worth clarifying the difference between Git and Git**hub**. Git is the software that looks after the version control of code, whereas Github is the website on which you publish and share your version controlled code. In practice this means that using Git to track versions of your code and then submit those changes to Github.
...
1. Create an 'SSH key' within the your platform R Studio.  This is an unique code that will be stored in your account, meaning you will not need to enter your password when interacting with Github.
2. Register the key with Github.
3. Configure git to set you username and email address.
...
We have written an introductory guide to using Git which you can access here: [here](https://moj-analytical-services.github.io/platform_user_guidance/using-github-in-rstudio.html)
