...
Before you can use Github with R Studio, you need to connect them together by creating an 'ssh key'.  Full guidance is [here](https://moj-analytical-services.github.io/platform_user_guidance/getting-started.html#configuring-git-and-github-for-use-on-the-analytical-platform)
...
1.	PRIVATE: Leave the default setting of your repository so its only visible to you as the creator.
...
### Step 3:  Navigate to your platform R Studio and make a copy of the Github project in your R Studio
...
### Step 4: Edit your files, track them using Git, and sync ('push') changes to Github
...
* Git will only become aware of changes you've made after you've saved the file as shown in the gif.  Unsaved changes are signified when the filename in the code editior tab is red with an asterix.
 ...
 ### Step 5: Sync ('push') your work with github.com
