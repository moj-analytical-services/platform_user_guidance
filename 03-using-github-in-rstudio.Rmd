...
The slides from from the ASD git training are [available here (dom1 access only)](S:\hq\102PF\Shared\Group_LCDSHD2\Analytical Services\ASD Training\Training materials\git\git_training_slides.pdf)
