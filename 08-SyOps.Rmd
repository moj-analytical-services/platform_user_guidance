...
- You should transfer the minimum datasets to the platform needed for the work you are doing
- All data transfers should be made from a secure computer system that is accredited to store OFFICIAL data such as DOM1 or QUANTUM
- Access to sensitive data should be provided on a 'need to know' basis.  You can use [data access groups](https://moj-analytical-services.github.io/platform_user_guidance/user-administration.html#teams-and-data-access-groups) to control data access.
