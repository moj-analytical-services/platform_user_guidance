...
The advice in this document relates to PRIVATE REPOSITORIES only.  Do not store OFFICIAL work in public repositories unless you are sure it is not sensitive.
...
You may use GitHub to store project writeups, so long as the write ups do not contain information or data which would violate the prohibitions on the use of GitHub set out below.

### Prohibitions: What can’t I use GitHub for?

In general, you should not be using GitHub to store datasets.

You **MUST NOT** use GitHub for the following purposes:
