...
- You must not put any sensitive (OFFICIAL) data into the platform. Sensitive data is classified `OFFICIAL` or higher. If you really need to put this kind of data into the platform, either:
  - get formal permission from [Robin Linacre](mailto:robin.linacre@digital.justice.gov.uk), or
  - get in contact on the `#analytical-platform` channel on Slack.
