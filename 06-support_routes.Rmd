...
* If none of the above methods have helped to solve the problem then the Data Science Hub (DaSH) team is happy to provide assistance, although please be aware that team members are under no obligation to do so and appreciate the time this may take away from their other work. Generally posting on the R slack channel is the best way to reach DaSH although... (email or just say post on slack?)
