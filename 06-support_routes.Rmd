...
The MoJ Digitech team have a slack channel where you can post questions and a Github page where you can raise a formal [issue ticket](https://github.com/ministryofjustice/analytics-platform/issues). Please allow sufficient time for the team to get back to you and be aware that (something about non essential support being a favour...)
...
* If none of the above methods have helped to solve the problem then the Data Science Hub (DaSH) team is happy to provide assistance, although please be aware that team members are under no obligation to do so and appreciate the time this may take away from their other work. Data science team members are active contributors to the Slack channels and creating a post there is the preferred method of contact.
...
* In a similar vein to R there is also a git [slack channel](https://asdslack.slack.com/). This should be the first port of call for specific questions, highlighting issues or general advice.
