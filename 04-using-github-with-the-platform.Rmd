...
Set this up by running this in your linux terminal (ie R Studio's 'terminal') and substitute your own PAT Token:
  
```{bash}
echo 'Sys.setenv("GITHUB_PAT" = "ax451...8838b1")' >> ~/.Rprofile
```
