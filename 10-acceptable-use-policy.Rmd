...
- Teams are responsible for who has access to their data when within the platform, and **must** actively manage personnel changes (Joiners, Movers, Leavers) to ensure the correct people have access to only the data they are currently permitted to access.
...
- Before you transfer any data into the platform, you **must** have completed information governance and management assessments, this is likely to include (but not be limited to): a Data Movement Form, a technical data migration/integration document, update Privacy Impact Assessments, update information management and asset logs and applicable privacy notices.
- Using the platform is likely to require authoriation from your SIRO (Senior Information Risk Owner) and/or IAO (Information Asset Owner).

## Controlling data access in the platform

- Data Owners are ultimately responsible for who has access to data while in the platform.
- Data Owners **must** actively manage delegated access for team members (popularly - Joiners, Movers, Leavers)
- Self-managed permissions through [data access groups](https://moj-analytical-services.github.io/platform_user_guidance/user-administration.html#teams-and-data-access-groups) must be used to provision and remove access as suitable - which is solely defined by Data Owners.

## Data Minimisation

- Consider [minimising data](https://moj-analytical-services.github.io/platform_user_guidance/annexes.html#data-minimisation) through pseudonymisation and anonymisation techniques.
