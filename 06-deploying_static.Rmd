...
Uses [this template](https://github.com/moj-analytical-services/webapp-template) to deploy is to deploy the full static web app from GitHub. You might want to do this when it is imperitive to version the full app. It would also make it easier for and collaborators to understand how the app works make edits and vett changes.
