...
### Sign up to GitHub
If you do not already have an account, head to https://github.com/ and sign up. When signing up, use all the default options, and make sure you save recovery codes as instructed. It's good practice to choose a username that does not feature upper case characters. Please use a secure password when signing up following this best practices guideline (see [here](https://github.com/ministryofjustice/itpolicycontent/blob/master/content/security/framework/password-standard.md)). Using a password manager could help you generating strong password, refer [here](https://moj-analytical-services.github.io/platform_user_guidance/annexes.html#password-manager) for more information.
