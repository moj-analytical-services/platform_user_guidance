...
### Sign up to GitHub
If you do not already have an account, head to https://github.com/ and sign up. When signing up, use all the default options, and make sure you save recovery codes as instructed. It's good practice to choose a username that does not feature upper case characters. Please use a secure password when signing up following this best practices guideline (see [here](https://github.com/ministryofjustice/itpolicycontent/blob/master/content/security/framework/password-standard.md)). Finally, using a password manager could help you generating strong password - e.g. free tier from LastPass (see [here](https://en.wikipedia.org/wiki/Password_manager) for more information about Password Manager).
