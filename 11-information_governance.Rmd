...
The Analytical Platform is hosted on [Amazon Web Services (AWS)](https://aws.amazon.com/) (a US company part of the Amazon group) with primary data storage and processing locations in their [their European regions](https://aws.amazon.com/about-aws/global-infrastructure/).
