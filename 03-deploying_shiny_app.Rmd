...
![](images/github_shiny_import.gif)
...
![](images/github_shiny_rstudio.gif)
...
![](images/github_packrat_snapshot.gif)
...
1. You will see a list of apps that have been detected.  Find yours and click on the link with its name (if you're app isnt listed then click "Scan Organisation Now" on the left hand menu and wait for the scan to complete.)

2. Then click on the branch you wish to deploy (this will usually be 'master')

3. Finally, click 'Build'

![](images/jenkins_build.gif)
