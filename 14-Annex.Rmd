...
A password manager assists in generating and retrieving complex password, potentially storing such passwords in an encrypted database, or calculating them on demand. We do encourage the use of them as they would give some huge advantages such as:

* They make it easy for you to use long, complex, unique passwords across different sites and services
* They are better than humans at spotting fake websites and can auto-logon
* They can generate new passwords when you need them and automatically paste them into the right places
* They can sync your passwords across all your devices
* They can securely store password recovery questions
* They can be help to share secrets between team members

Password managers do have some drawbacks when using them:

* They are single point of failure: if you lose your master password, you could lose access to all your passwords at once
* They are attractive targets in themselves. They've been successfully attacked in the past, and realistically they will be again. So all your passwords could get stolen in one go
* They might not support all your devices and browsers

For more information, you can read [here](https://www.ncsc.gov.uk/blog-post/what-does-ncsc-think-password-managers) what does NCSC think about password manager. The following section would present a list of the most popular Password Managers at the moment.
